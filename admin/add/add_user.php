...
if(isset($_POST['sbm'])) 
{
    ...
    $matkhau = md5($matkhau);
    $sql = "INSERT INTO khachhang(tenkh, sdt,gioitinh,ngaysinh,diachi,email,matkhau) VALUES('$tenkh','$sdt', '$gender','$ngaysinh','$diachi','$email','$matkhau')";
    ...
    <div class="borderhome" style = "border: 1px solid;margin-bottom: 46px;"></div>
        <form action="" method="POST">
            ...
            <div style = "display: flex;">
                ...
                <div class="adduser__item" style = "display: flex;margin-bottom: 30px; height: 34px; color: #000;align-items: center;">
            ...
            <div style = "display: flex;">
                ...
                <div class="adduser__item" style = "display: flex;margin-bottom: 30px; height: 34px;">
                    ...
                    <textarea name="diachi" id="" required placeholder= "Địa chỉ" cols="30" rows="10" style = "width: 386px;height: 110px;outline: none;"></textarea>
                </div>
            </div> 
             
            <div class="adduser__item" style = "display: flex;margin-bottom: 30px;">
                <h5 style = "font-size: 15px;color: #000;width: 11.5%;margin-top: 4px;">Mật khẩu</h5>
