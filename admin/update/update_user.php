            ...
            <form action="" method="POST">
                <div style = "display: flex;">
                    <div class="adduser__item" style = "display: flex;margin-bottom: 30px; height: 34px;margin-right: 10%;">
                        ...
                        <input name = "makh" type="text" placeholder= "Mã khách hàng" value="<?php echo $row['makh'];?>" style = " width: 330px; pointer-events: none;background: #f2f2f2;border: 1px solid #CCC;opacity: 0.5;">
                    </div>
                ...
                <div class="adduser__item" style = "display: flex;margin-bottom: 30px;">
                    <h5 style = "font-size: 15px;color: #000;width: 11.2%;margin-top: 4px;">Email</h5>
