    ...
    <div class="col-sm-12">
      <div class="card-box table-responsive">
        <div class="btn__add" style = " margin-top: 15px; border-radius:3px">
          <a href="./dashboard.php?page=appdh" style = "padding: 9px 28px; border: 1px solid;border-radius:3px"><i class="fa fa-plus"></i>Tạo đơn hàng</a>
        </div>
        ...
        <tbody>
          <?php
            $qry = $conn->query("SELECT `MaHD`,`khachhang`.`tenkh` AS `tenkhs`,`hoadon`.`diachi`,`hoadon`.`ngayhd`,`hoadon`.`tongtien`,`tinhtrang`  FROM `khachhang`, `hoadon` WHERE `khachhang`.`makh` = `hoadon`.`makh` ORDER BY `MaHD` DESC");
          ...
          <tr>
            ...
            <td class="text-center">
              <div class="btn-group">
                ...
                <a href="./dashboard.php?page=list/list_product_detail&mahd=<?php echo $row['MaHD'] ?>" class="btn btn-info btn-flat">
                  <i class="fas fa-eye"></i>
                </a>
                <a href="./dashboard.php?page=delete/delete_oder&mahd=<?php echo $row['MaHD'] ?>" class="btn-infos btn  btn-flat">
