    ...
    <div class="col-sm-12">
      <div class="card-box table-responsive">
        <div class="btn__add" style = " margin-top: 15px; border-radius:3px">
          <a href="./dashboard.php?page=add/add_type_product" style = "padding: 9px 28px; border: 1px solid;border-radius:3px"><i class="fa fa-plus"></i>Thêm loại sản phẩm</a>
        </div>
        <div class="col-sm-6"><div id="datatable_filter" class="dataTables_filter"><label> <class="form-control input-sm placeholder="" aria-controls="datatable"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="datatable" class="table table-striped table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="datatable_info">
          ...
          <tbody>
            <?php
              $qry = $conn->query("SELECT * FROM LoaiSP ORDER BY maloai DESC");
            ...
            <tr>
              ...
              <td class="text-center">
                <div class="btn-group">
                  <form action="./dashboard.php?page=update/update_type_product" method = "POST">
                  ...
                  <a href="./dashboard.php?page=view_product&maloai=<?php echo $row['maloai'] ?>" class="btn btn-info btn-flat">
                    <i class="fas fa-eye"></i>
                  </a>
                  <a href="./dashboard.php?page=delete/delete_type_product&maloai=<?php echo $row['maloai'] ?>" class="btn-infos btn  btn-flat">
